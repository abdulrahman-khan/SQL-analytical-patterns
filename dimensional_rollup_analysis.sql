-- Dimensional rollup analysis using GROUPING SETS
-- materializes a dashboard table with multi-level aggregations of event counts by OS, device, and browser.



DROP TABLE IF EXISTS device_hits_dashboard;
